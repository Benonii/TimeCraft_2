      ...
      <div className="relative flex items-center mt-10 min-h-[900px]">
        ...
        <div className='flex justify-center absolute left-24 md:mt-0 w-[73%] ml-1 max-w-[700px]'>
          <Button variant='outline' 
            className=' px-4 py-2 md:py-6 rounded-md shadow-lg font-monomaniac border border-gray-500 text-gray-500 hover:text-black hover:border-black md:text-3xl md:px-7 h-fit'>
            Create user
          </Button>
          <Button variant='default' 
            className='ml-2 bg-yellow1 px-4 py-2 md:py-6 rounded-md shadow-lg font-monomaniac text-white md:text-3xl md:px-7 h-fit'>
            Sign up instead
          </Button>
      </div>
      </div>
