      ...
      <div className="relative flex items-center mt-10 min-h-[900px]">
        ...
        <div className='absolute top-3 left-24'>
          ...
          <div className='flex flex-col items-center justify-top ml-3 mt-5 bg-orange3 text-white rounded-lg h-48 md:h-64 w-[60vw] max-w-[500px]'>
            ...
            <p className='font-monomaniac font-light text-2xl md:text-4xl'><span className='font-bold mr-1'>TPT:</span> {user.tpt} hours</p>
            <p className='font-monomaniac font-light text-2xl md:text-4xl'><span className='font-bold' mr-1>TWT:</span> {user.twt}</p>
            <p className='font-monomaniac font-light text-2xl md:text-4xl'><span className='font-bold'>Efficiency:</span> {Number(user.tpt)/(Number(user.tpt) + Number(user.twt)) || 0}</p>
          </div>
